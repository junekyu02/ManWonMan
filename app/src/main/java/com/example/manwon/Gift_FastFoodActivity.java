...
public class Gift_FastFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(position -> {
            Intent intent = new Intent(Gift_FastFoodActivity.this, Gift_Userchange_Activity.class);
    ...
    private void fetchGiftsFromFirebase() {
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                List<String> FastfoodBrands = Arrays.asList("맥도날드", "롯데리아", "버거킹", "맘스터치", "프랭크버거", "쉐이크쉑");
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (FastfoodBrands.contains(itemType)) {
