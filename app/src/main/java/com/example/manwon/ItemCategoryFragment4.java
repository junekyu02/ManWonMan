...
public class ItemCategoryFragment4 extends Fragment {
    public ItemCategoryFragment4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_item_category4, container, false);

        // category_item_1
        TextView categoryitem1 = rootView.findViewById(R.id.category_item_1);
        categoryitem1.setOnClickListener(v -> {
            String selectedText = "주방 및 생활 가전";
        ...
        categoryitem2.setOnClickListener(v -> {
            String selectedText = "영상 및 음향 기기";
            int selectedColor = Color.BLACK;
