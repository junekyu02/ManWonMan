...
public class Gift_TravelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(position -> {
            Intent intent = new Intent(Gift_TravelActivity.this, Gift_Userchange_Activity.class);
    ...
    private void fetchGiftsFromFirebase() {
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                List<String> travelBrands = Arrays.asList("여기 어때", "야놀자");
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (travelBrands.contains(itemType)) {
