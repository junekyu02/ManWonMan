...
public class Gift_ConvenienceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(position -> {
            Intent intent = new Intent(Gift_ConvenienceActivity.this, Gift_Userchange_Activity.class);
    ...
    private void fetchGiftsFromFirebase() {
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                List<String> convenienceBrands = Arrays.asList("CU", "세븐일레븐", "이마트", "GS25", "이마트24", "홈플러스");
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (convenienceBrands.contains(itemType)) {
